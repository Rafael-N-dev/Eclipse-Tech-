...
export const Route = createFileRoute("/privacidade")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Saiba como a Eclipse Tech coleta, utiliza e protege seus dados pessoais.",
      },
  ...
  return (
    <div className="min-h-screen">
      ...
      <main className="mx-auto max-w-3xl px-4 py-12 sm:px-6">
        ...
        <p className="mt-3 text-xs text-muted-foreground">Última atualização: 7 de maio de 2026</p>
        ...
        <div className="prose-invert mt-8 space-y-6 text-muted-foreground">
          ...
          <section>
            ...
            <p className="mt-2">
              Utilizamos cookies próprios e de terceiros (Google Analytics, Google AdSense) para
              personalizar conteúdo, exibir anúncios relevantes e analisar tráfego. Você pode
          ...
          <section>
            ...
            <p className="mt-2">
              A Eclipse Tech exibe anúncios via Google AdSense. O Google pode utilizar cookies para
              personalizar a publicidade com base em visitas anteriores a este e outros sites. Saiba
              mais em
              <a
          ...
          <section>
            ...
            <p className="mt-2">
              Não vendemos seus dados pessoais. Compartilhamos informações apenas com parceiros
              estritamente necessários (analytics e publicidade) e quando exigido por lei.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mt-2">
              ...
              enviando um e-mail para <span className="text-neon">privacidade@eclipsetech.com</span>
              .
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mt-2">
              ...
              <a href="/contato" className="text-neon underline">
                {" "}
                página de contato
              </a>
              .
